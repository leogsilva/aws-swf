...
public class FileProcessingWorkflowZipImpl implements FileProcessingWorkflow {
  ...
  public void processFile(final String sourceBucketName, final String sourceFilename, final String targetBucketName,
    ...
    // Use runId as a way to ensure that downloaded files do not get name
    // collisions
    ...
    new TryCatchFinally() {
      ...
      protected void doTry() throws Throwable {
        ...
        Promise<Void> fileProcessed = processFileOnHost(localSourceFilename, localTargetFilename,
            activityWorkerTaskList);
